...
# 레이블당 샘플 개수 확인
prn_sample_cnt(np.unique(train_labels, return_counts=True)) #유니크한 값 : 0이 만장 1이 만장 등을 계산해달라는거당!
prn_sample_cnt(np.unique(test_labels, return_counts=True)) #검증하기위한 테스트벨류!
