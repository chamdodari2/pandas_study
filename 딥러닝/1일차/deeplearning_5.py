...
dense1 = layers.Dense(100, activation='relu', input_shape=(28 * 28,), name="hidden1")  #은닉층 ! 네임 지어준거임! 서머리에서 확인가능!
# 뉴런의 개수 : 10, 뉴련출력에 적용할 함수 : softmax, 입력 앞의 층 (은닉층)
dense3 = layers.Dense(50, activation='relu', name="hidden2")
drop4 = layers.Dropout(0.4) # overfit 감소 40%     #오버핏 감소!! 과적합 감소시키기!!
dense2 = layers.Dense(10, activation='softmax', name="output")  #입력된 순서대로 적용해조!
