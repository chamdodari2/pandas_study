...
test_images = test_images.astype('float32') / 255 # 컴ㅍ터가 쉽게 인식할수 있또록 실수형으로 바깠다!! 0~255  --> 0~1   (0.97이면 1로 하겠당) 여기에 쓰는 알고리즘을 뭫 쓰느냐에 대해  알고리즘 대회 한당 세계쩍으루. 우리는 만들지않고 이용해서 정확하게 예측할수 있도록 하는거랃ㅇ
